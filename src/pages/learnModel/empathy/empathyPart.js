...
const empathy_1 = require('../../../../assets/icons/learn/empathy/empathy_1.png');
...
const EmpathySection = () => {
  ...
  const handleClickMove = async () => {
    console.log('-------------data--------------');
    navigation.navigate('HelpEmpathySection');
  };
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Header
        visible={true}
        text={'Empathy Difficulties'}
        color={'#FFFBF8'}
        editalbe={false}
        progress={progress}
      />

      <StepItem avatar={empathy_1} content={content} />
