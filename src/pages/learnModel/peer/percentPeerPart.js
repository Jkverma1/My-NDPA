  ...
  const quizData = [
    {
      ...
      questions: [
        {
          id: 1,
          text: "What kinds of peer difficulties people face?",
          answer: ["Rejection", "Bullying", "Aggression", "Conflict", "⁠Lack of Friendship"],
          correctAnswer: ["Rejection", "Bullying", "Aggression", "Conflict", "⁠Lack of Friendship", "self esteem issues", "violence", "exclusion"],
        },
        {
          id: 2,
          text: "Why is the safe space is important to you?",
          answer: ["Respect", "Safe Dialogue", "Building Trust", "Fostering Growth"],
          correctAnswer: ["Respect", "Safe Dialogue", "Building Trust", "Fostering Growth"],
        }
      ]
    },
  ];
...
export default PercentPeerSection;
