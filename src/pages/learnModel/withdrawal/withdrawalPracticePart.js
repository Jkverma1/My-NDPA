...
const withdrawal_chat = require('../../../../assets/icons/learn/withdrawal/withdrawal_practice_background.png');
const close_ico = require('../../../../assets/icons/m_close_ico.png');
const idea_ico = require('../../../../assets/icons/learn/idea_ico.png');

const { width: screenWidth } = Dimensions.get('window');

const WithdrawalPracticePart = ({ navigation }) => {
  ...
  const handleStart = () => {
    setModalVisible(false);
    navigation.navigate('PracticeWithdrawalSection');
  };
...
export default WithdrawalPracticePart;
