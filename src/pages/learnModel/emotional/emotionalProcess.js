...
const Emotional_part_1 = require('../../../../assets/icons/learn/emotional/Emotional_part_1.png');
const Emotional_part_2 = require('../../../../assets/icons/learn/emotional/Emotional_part_2.png');
const close_ico = require('../../../../assets/icons/m_close_ico.png');
const idea_ico = require('../../../../assets/icons/learn/idea_ico.png');

const { width: screenWidth } = Dimensions.get('window');

const EmotionalProcess = ({ navigation }) => {
  const route = useRoute();
  const { move, part } = route.params;
  const bgImage = part === 1 ? Emotional_part_1 : Emotional_part_2;
  const modalText = part === 1 ? "Imagine your friend Sarah has been dealing with a lot lately. Eventually, she has an emotional outburst. You're there to support her." : "Let’s think how we can help in this situation"
  ...
  const handleStart = () => {
    setModalVisible(false);
    navigation.navigate(part === 1 ? "EmotionalSection" : 'HelpEmotionalSection');
  };

  const handleClickMove = async () => {
    console.log('-------------data--------------');
    navigation.navigate('EmotionalProcessSection', { move: false , part: 2 });
  };
