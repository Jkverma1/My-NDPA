...
import { sadness_2 } from '../../../utils/content';

const worry_part_1 = require('../../../../assets/icons/learn/worry/Worry_part_1.png');
const worry_part_2 = require('../../../../assets/icons/learn/worry/Worry_part_2.png');
const close_ico = require('../../../../assets/icons/m_close_ico.png');
const idea_ico = require('../../../../assets/icons/learn/idea_ico.png');

const { width: screenWidth } = Dimensions.get('window');

const WorryProcess = ({ navigation }) => {
  const route = useRoute();
  const { move, setMove, part } = route.params;
  const bgImage = part === 1 ? worry_part_1 : worry_part_2;
  const modalText = part === 1 ? "Imagine your friend is stressed about first day at new school, and you want to help him." : "Let’s think how we can help in this situation"
  ...
  const handleStart = () => {
    setModalVisible(false);
    navigation.navigate(part === 1 ? "WorrySection" : "HelpWorrySection");
  };

  const handleClickMove = async () => {
    console.log('-------------data--------------');
    navigation.navigate('WorryProcessSection', { move: false , part: 2 });
  };
