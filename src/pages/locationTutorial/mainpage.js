...
const query = {
  key: process.env.GOOGLE_API_KEY_ANDROID__,
  language: 'en',
  types: 'address',
...
const Mainpage = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://maps.googleapis.com/maps/api/place/details/json?placeid=${placeId}&key=${process.env.GOOGLE_API_KEY_ANDROID__}`,
    )
