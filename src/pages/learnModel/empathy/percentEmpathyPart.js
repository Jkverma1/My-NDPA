...
const PercentEmpathySection = () => {
  const navigation = useNavigation();
  const [calculatedPercentage, setCalculatedPercentage] = useState(0);

  const quizData = [
    {
      step: "Step 3. Practice",
      questions: [
        {
          id: 1,
          text: "If somebody is screaming and shouting, this is clearly an emotional outburst - what would you do?",
          answer: ["Find Out the Reason", "Take Deep Breath", "Alert Adult", "Talk in Calm Manner"],
          correctAnswer: ["Find Out the Reason", "Take Deep Breath", "Alert Adult", "Talk in Calm Manner"],
        },
        {
          id: 2,
          text: "Someone is crying and is feeling very upset, what would you do?",
          answer: ["Listen Attentively","Ask Why They're Upset","Offer Support", "Provide Tissues"],
          correctAnswer: ["Listen Attentively","Ask Why They're Upset","Offer Support", "Provide Tissues"]
        },
        {
          id: 3,
          text: "If you see one person criticizing the other, how do you think the one criticized would feel, and what would you do about it?",
          answer: ["Find Out the Reason", "Handle Delicately", "Encourage Respect", "De-escalate if Tensions Rise"],
          correctAnswer: ["Find Out the Reason", "Handle Delicately", "Encourage Respect", "De-escalate if Tensions Rise"],
        }
      ]
    },
  ];
...
export default PercentEmpathySection;
