...
const practice_1 = require('../../../../assets/icons/learn/peer/practice_1.png');
const practice_2 = require('../../../../assets/icons/learn/peer/practice_2.png');
...
const PracticePeerSection = () => {
  ...
  const handleClickMove = async () => {
    console.log('-------------data--------------');
    navigation.navigate('PercentPeerSection');
  };
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      {step_1 && (
        <ItemBlock
          dash_icon={practice_1}
          datas={boxData}
          content={'What kinds of peer difficulties people face?'}
        />
      )}
      {step_2 && (
        <ItemBlock
          dash_icon={practice_2}
          datas={boxData}
          content={'Why is the safe space is important to you?'}
        />
      )}
...
export default PracticePeerSection;
