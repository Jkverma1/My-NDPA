...
const excellentIconImage = require('../../../assets/icons/learn/personal_identity/excellent_ico.png');

const {width: screenWidth} = Dimensions.get('window');

const ExitSpeakingPage = ({navigation}) => {
      ...
      <Modal visible={modalVisible} transparent={true} animationType="slide">
        <View style={styles.overlay}>
          ...
          <View style={styles.modalContainer}>
            ...
            <Image source={excellentIconImage} style={styles.centerImage} />
...
export default ExitSpeakingPage;
