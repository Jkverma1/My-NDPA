...
import WithdrawalFightPart from './withdrawalFightPart';
import WithdrawalHelpPart from './withdrawalHelpPart';
import WithdrawalPracticePart from './withdrawalPracticePart';
...
const MainWithdrawalSection = () => {
  return (
    <Stack.Navigator initialRouteName="StartWithdrawalSection">
      ...
      />
      <Stack.Screen
        name="WithdrawalFightSection"
        component={WithdrawalFightPart}
        options={{headerShown: false}}
        initialParams={{param: false}}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name="WithdrawalHelpSection"
        component={WithdrawalHelpPart}
        options={{headerShown: false}}
        initialParams={{param: false}}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name="WithdrawalPracticeSection"
        component={WithdrawalPracticePart}
        options={{headerShown: false}}
        initialParams={{param: false}}
      />
      <Stack.Screen
