...
const withdrawal_fight_chat = require('../../../../assets/icons/learn/withdrawal/withdrawal_chat_background.png');
...
const WithdrawalSection = () => {
  ...
  const handleMove = async () => {
    if (buttonType) {
      setMove(true);
      setShowModal(false);
      navigation.navigate('WithdrawalFightSection', { move: true , setMove : setMove });
      return;
    }
    setShowModal(false);
  };
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.b3_text}>{step ? "Continue" : "Next"}</Text>
      </TouchableOpacity>
      <CustomGreatModal
        visible={showModal}
