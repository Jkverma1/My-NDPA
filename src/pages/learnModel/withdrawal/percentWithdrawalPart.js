...
const PercentWithdrawalSection = () => {
  const navigation = useNavigation();
  const [calculatedPercentage, setCalculatedPercentage] = useState(0);

  const quizData = [
    {
      step: "Step 1. Situation",
      questions: [
        {
          id: 1,
          text: "How does Abdul feel?",
          answer: ["Sadness", "Confusion", "Hurt", "Loneliness"],
          correctAnswer: ["Sadness", "Confusion", "Hurt", "Loneliness", "Anger", "Guilt"]
        }
      ]
    },
    {
      ...
      questions: [
        {
          id: 1,
          text: "What can Abdul do to cope with this situation?",
          answer: ["Relaxation Techniques", "Breathing Exercises", "Keep a Journal"],
          correctAnswer: ["Relaxation Techniques", "Breathing Exercises", "Keep a Journal", "Make New Friends", "Express Emotions"]
        }
      ]
    },
    {
      ...
      questions: [
        {
          id: 1,
          text: "If I were Abdul, I might:",
          answer: ["Keep a Journal", "Make New Friends", "Express Emotions"],
          correctAnswer: ["Relaxation Techniques", "Breathing Exercises", "Keep a Journal", "Make New Friends", "Express Emotions"]
        }
      ]
    }
...
export default PercentWithdrawalSection;
